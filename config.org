...
- [[#theme-messed-up-between-emacsclient-and-gui][theme messed up between emacsclient and gui]]
- [[#loadkkkj-customuu-bindingsujk][Loadkkkj CUSTOMuu BINDINGSujk]]
...
#+END_SRC
* theme messed up between emacsclient and gui

#+BEGIN_SRC emacs-lisp

#+END_SRC

* Loadkkkj CUSTOMuu BINDINGSujk
